...
%\begin{IEEEbiography}{Frix O. Frix}
% sdfnksfjnsdovjndsifn
%\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{png/papad}}]{Frixos Papadopoulos} received the BSc degree in Computer Science from the Department of Electronics and Computer Science, University of Southampton in 2020. He is a prospective postgraduate student in machine learning and his research interests are machine learning and bioinformatics.
\end{IEEEbiography}
